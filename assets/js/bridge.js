...
$(function(){
    $.ajax({
        type:"GET",
        //url:"http://localhost/FinalPresentation2-master/requests.php"
...
$(document).ready(function(){
    ...
    $("#querybtn").click(function(){
        ...
        $.ajax({
            type:"GET",
            //url:"http://localhost/FinalPresentation2-master/discovery.php",
    ...
    function play(elementClassIndex){
        ...
        $.ajax({
            type:"GET",
            //url:"http://localhost/FinalPresentation2-master/text2speech.php",
            url:"https://finalpresentation2.mybluemix.net/text2speech.php",
            data: {data:test},
            contentType: "application/json"
        }).done(function(res){
            var result = JSON.parse(res);
            //var audioURL = "http://localhost/FinalPresentation2-master/" + result["audiofile"];
